...
public class PageTag extends TagSupport {
  ...
  private static final String TOP =
      "<div class=\"row text-center\"><div class=\"col-lg-12\"><ul class=\"pagination\">";
  private static final String IF_FIRST_PAGE =
  ...
  public int doStartTag() throws JspException {
    try {
      ...
      if (page == 1) {
        ...
        pageContext
            .getOut()
            .write("<li><a href=\"" + href + "&page=" + (page - 1) + "\">&laquo;</a></li>");
      }
      for (int i = 1; i <= pageAmount; i++) {
        if (i == page) {
          ...
          pageContext
              .getOut()
              .write("<li><a href=\"" + href + "&page=" + i + "\">" + i + "</a></li>");
        }
      }
      if (page != pageAmount) {
        pageContext
            .getOut()
            .write("<li><a href=\"" + href + "&page=" + (page + 1) + "\">&raquo;</a></li>");
      } else {
