...
/**
 * Interface {@code VerifyDAO} declare method that appropriate just for {@link
 * by.training.hrsystem.domain.Verify Verify} objects.
 *
 * @author Vladislav
...
public interface VerifyDao {
  ...
  /**
   * Method {@code verifyResumePass} allows you to set status "pass" if you enjoyed given resume.
   *
   * @param idVerify key of entity,it will use to find verify object from database.
   * @throws DAOException if a database access error occurred or error interaction with connection
   *     pool while finding verify by id.
   */
  void verifyResumePass(int idVerify) throws DAOException;

  /**
   * Method {@code verifyResumeNotPass} allows you to set status " not pass" if you not enjoyed
   * given resume.
   *
   * @param idVerify key of entity,it will use to find verify object from database.
   * @throws DAOException if a database access error occurred or error interaction with connection
  ...
  /**
   * Method {@code verifyList} allows you to find list of resume belonging to given vacancy.
   *
   * @param idVacancy key of entity,it will use to find verify object from database.
