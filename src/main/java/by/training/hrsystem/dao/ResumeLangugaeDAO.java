...
/**
 * Interface {@code ResumeLangugaeDAO} extends {@link AbstractDAO} and declare method than
 * appropriate just for {@link by.training.hrsystem.domain.ResumeLanguage ResumeLanguage} objects.
 *
 * @author Vladislav
 * @see AbstractDAO
...
public interface ResumeLangugaeDAO extends AbstractDAO<ResumeLanguage> {
  /**
   * Method {@code getResumeLangByIdResume} allow to find list of resume languages objects by
   * idResume
   *
