...
/**
 * Interface {@code UserDAO} extends {@link AbstractDAO} and declare method than
 * appropriate just for {@link by.training.hrsystem.domain.User User} objects.
 * 
 * 
 * @author Vladislav
 * 
...
public interface UserDAO extends AbstractDAO<User> {
	/**
	 * Method {@code userAuthentication} allow login in the human resource
	 * system
	 * 
	 * 
	 * @param email
	 ...
	 *             connection pool while login in the system.
	 * 
	 * @see AbstractDAO
	 * @see by.training.hrsystem.domain.User User
	 */
	 ...
	 * @throws DAOException
	 *             if a database access error occurred or error interaction with
	 *             connection pool while finding user by email.
	 * 
	 * @see AbstractDAO
	 * @see by.training.hrsystem.domain.User User
	 */
	 ...
	 * @throws DAOException
	 *             if a database access error occurred or error interaction with
	 *             connection pool while finding user by id vacancy.
	 * 
	 * @see AbstractDAO
	 * @see by.training.hrsystem.domain.User User
	 * 
	 ...
	 * 
	 * @param idResume
	 *            key of entity,it will use to find user object from database
	 * @return user user object if user exist; else return null;
	 * @throws DAOException
	 *             if a database access error occurred or error interaction with
	 *             connection pool while finding user by id resume.
	 * 
	 * @see AbstractDAO
	 * @see by.training.hrsystem.domain.User User
	 * 
	 ...
	 * @throws DAOException
	 *             if a database access error occurred or error interaction with
	 *             connection pool while finding count of applicants.
	 * 
	 * @see AbstractDAO
	 * @see by.training.hrsystem.domain.User User
	 */
