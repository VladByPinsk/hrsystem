 ...
 * with DAO layer just for {@link by.training.hrsystem.domain.Education
 * Education} objects.
 * 
 * @author Vladislav
 * 
...
public interface EducationService {
	/**
	 * Method {@code addEducation} receiving string fields from command layer,
	 * validate and parse them(if its required), create an object on the basis
	 * of these fields and send it into method {@code add} class
	 * {@link by.training.hrsystem.dao.impl.DBEducationDAO DBEducationDAO}
	 * through the abstract factory.
	 * 
	 * @param institution
	 *            String filed receiving from command layer.
	 * @param faculty
	 *            String filed receiving from command layer.
	 * @param department
	 *            String filed receiving from command layer.
	 ...
	 *             if parameter institution not valid.
	 * @throws WrongFacultyServiceException
	 *             if parameter faculty not valid.
	 * @throws WrongDepartmentServiceException
	 *             if parameter department not valid.
	 * @throws WrongEducationServiceException
	 *             if parameter education not valid.
	 * @throws WrongCourseServiceException
	 *             if parameter course not valid.
	 * @throws WrongGradYearServiceException
	 *             if parameter grandYer not valid.
	 * @throws WrongPostGraduateServiceException
	 *             if parameter postgraduate not valid.
	 * @throws ServiceException
	 *             if something goes wrong on DAO layer or when parse string
	 *             fields.
	 */
	...
	/**
	 * Method {@code updateEducation} receiving string fields from command
	 * layer, validate and parse them(if its required), create an object on the
	 * basis of these fields and send it into method {@code update} class
	 * {@link by.training.hrsystem.dao.impl.DBEducationDAO DBEducationDAO}
	 * through the abstract factory.
	 * 
	 * @param institution
	...
	/**
	 * Method {@code deleteEducation} receiving string field id education from
	 * the command layer, parse it and sends it into method {@code delete} class
	 * {@link by.training.hrsystem.dao.impl.DBEducationDAO DBEducationDAO}
	 * through the abstract factory.
	 * 
	 * @param idEducation
	...
	/**
	 * Method {@code updateEducation} receiving string field id resume from
	 * command layer, parse it, and by that id receives collection of education
	 * objects from the DAO layer, by id resume.
	 * 
	 * @param idResume
	 *            String filed receiving from command layer.
