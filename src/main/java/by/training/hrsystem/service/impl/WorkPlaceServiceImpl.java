...
=======
  ...
  public void addWorkplace(
      String companyName, String position, String dateBegin, String dateEnd, String idResume)
...
>>>>>>> Stashed changes
    ...
    try {
      if (!Validation.validateDate(
          Parser.parseToFullDate(dateBegin), Parser.parseToFullDate(dateEnd))) {
...
=======
  ...
  public void updateWorkplace(
      String companyName, String position, String dateBegin, String dateEnd, String idWorkPlace)
      throws ServiceException {
    logger.debug(
        "WorkPlaceServiceImpl.updateWorkPlace() : user's data is valid (companyName = {}, position={}, dateBigin = {}, "
            + " dateEnd = {}, idWorkPlace={})",
...
>>>>>>> Stashed changes
  ...
  public void deleteWorkplace(String idWorPlace) throws ServiceException {
    logger.debug(
        "WorkPlaceServiceImpl: deleteWorkPlace() : user's data is valid (idWorkPlace={})",
        idWorPlace);
  ...
  @Override
  public List<WorkPlace> selectWorkPlaceByIdResume(String idResume) throws ServiceException {
    logger.debug(
        "WorkPlaceServiceImpl.selectWorkPlaceByIdResume() : user's data is valid (idResume={})",
        idResume);
