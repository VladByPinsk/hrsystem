...
<fmt:message bundle="${locale}" key="locale.publishDate"
	var="publishDate" />
<fmt:message bundle="${locale}" key="locale.showListResponted"
	var="showListResponted" />
									...
									<div class="thumbnail">
										<div class="caption">
											...
											<a
												...
												class="btn btn-primary" role="button">${showListResponted}</a> <a
												href="Controller?command=to-pass-verify-applicant&vacancy-id=${vacancy.idVacancy}"
												class="btn btn-primary" role="button">${showWhoPass}</a>
										</div>
									</div>
								</div>
							</c:forEach>
