...
<fmt:message bundle="${locale}" key="locale.vacancy.editTranslation"
	var="edit" />
...
<fmt:message bundle="${locale}" key="locale.addVacancy.contractual"
	var="contractual" />
<fmt:message bundle="${locale}" key="locale.addVacancy.editTransl"
	var="editTransl" />
	...
	<div class="container">
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">${editTransl}
					${requestScope.vacancy.name }</h3>
			</div>
			<div class="panel-body">
				<form class="form-horizontal" action="Controller" method="post">
					<input type="hidden" name="command" value="edit-transl-vacancy">
					...
					<div class="form-group">
						...
						<div class="col-xs-6">
							<input type="text" class="form-control" name="vacancyName"
								value="${requestScope.vacancy.name}" required maxlength="50">
							<c:choose>
					...
					<div class="form-group">
						...
						<div class="col-xs-6">
							<textarea class="form-control" rows="20" name="description"
								maxlength="1000" required>${requestScope.vacancy.description}</textarea>
							<c:choose>
